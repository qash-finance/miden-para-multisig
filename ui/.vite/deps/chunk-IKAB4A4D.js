// node_modules/.pnpm/@getpara+core-components@2.0.0-alpha.73/node_modules/@getpara/core-components/dist/esm/prand-4c0d6ea7.js
var Prando = class _Prando {
  // ================================================================================================================
  // CONSTRUCTOR ----------------------------------------------------------------------------------------------------
  /**
  ...
  constructor(seed) {
    ...
    if (typeof seed === "string") {
      ...
      this._seed = this.getSafeSeed(_Prando.MIN + Math.floor((_Prando.MAX - _Prando.MIN) * Math.random()));
    }
    this.reset();
  }
  // ================================================================================================================
  ...
  next(min = 0, pseudoMax = 1) {
    this.recalculate();
    return this.map(this._value, _Prando.MIN, _Prando.MAX, min, pseudoMax);
  }
  /**
  ...
  nextInt(min = 10, max = 100) {
    this.recalculate();
    return Math.floor(this.map(this._value, _Prando.MIN, _Prando.MAX, min, max + 1));
  }
  /**
...
//# sourceMappingURL=chunk-IKAB4A4D.js.map
